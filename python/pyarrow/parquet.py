...
col_encoding : dict, default None
    ...
    Valid values: {'PLAIN', 'PLAIN_DICTIONARY', 'RLE', 'BIT_PACKED',
                   ...
                   'DELTA_BYTE_ARRAY', 'RLE_DICTIONARY',
                   'BYTE_STREAM_SPLIT'}
    Certain encodings are only compatable with certain data types. Please refer
    to the parquet format documention for details 
